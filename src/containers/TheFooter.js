      ...
      <div class="d-flex flex-column">      
              <div style={{fontStyle: 'italic', display:"flex",  justifyContent: "center", flexWrap:"wrap" , marginTop:40}} >
                     ...
                     <img src={uniq} width={"95px"} height={"30px"} style={{marginRight:10, marginTop:5}} />
                      ...
                      <img src={mbds} width={"100px"} height={"30px"} style={{marginRight:10, marginTop:5}} />
                      <img src={bme} width={"40px"} height={"30px"} style={{marginRight:10, marginTop:5}} />

                      <img src={fds} width={"80px"} height={"30px"} style={{marginRight:10, marginTop:5}} />
                      <img src={cnigs} width={"80px"} height={"30px"} style={{marginRight:10, marginTop:5}} />
              
                      <img src={suisse} width={"100px"} height={"30px"} style={{marginRight:10, marginTop:5}} />
